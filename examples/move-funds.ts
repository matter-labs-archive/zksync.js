...
(async () => {
    ...
    console.log("==================================");
    console.log("Unlocking account with onchain tx: ", syncWallet.address());
    const unlockAccountHandle = await syncWallet.unlockAccountOnchain();
    ...
    console.log("==================================");
    console.log("Unlocking account with offchain tx: ", syncWallet2.address());
    const unlockAccount2Handle = await syncWallet2.unlockAccount();
    ...
    console.log("Full exit committed, block", fullExitReceipt.block.blockNumber);
